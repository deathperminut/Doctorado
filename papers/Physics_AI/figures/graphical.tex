...
% =============================================
\begin{scope}
  \clip (1.7, 4.65) circle (1.15);
  \node[inner sep=0pt] at (1.7, 4.65) {
    \includegraphics[width=2.45cm]{Physics_AI/graphical/domain1.pdf}
  };
\end{scope}
\shade[ball color=white, opacity=0.15] (1.7, 4.65) circle (1.15);
\draw[darktext!35, thin] (1.7, 4.65) circle (1.15);
 
% Dots
\node[darktext, font=\sffamily\bfseries\large] at ({\cw/2}, 4.65) {$\cdots$};
 
\begin{scope}
  \clip (4.6, 4.65) circle (1.15);
  \node[inner sep=0pt] at (4.6, 4.65) {
    \includegraphics[width=2.45cm]{Physics_AI/graphical/domain2.pdf}
  };
\end{scope}
\shade[ball color=white, opacity=0.15] (4.6, 4.65) circle (1.15);
\draw[darktext!35, thin] (4.6, 4.65) circle (1.15);
...
\node[draw=col1border, fill=white, rounded corners=3pt, 
      font=\sffamily\small, inner sep=5pt, text width=5.2cm, align=center]
  at ({\cw/2}, 1.2) {
...
% =============================================
\begin{scope}
  \clip ({\cw/2}, 7.85) circle (0.8);
  \node[inner sep=0pt] at ({\cw/2}, 7.85) {
    \includegraphics[width=2.1cm]{Physics_AI/graphical/domain3.pdf}
  };
\end{scope}
\shade[ball color=white, opacity=0.15] ({\cw/2}, 7.85) circle (0.8);
\draw[darktext!35, thin] ({\cw/2}, 7.85) circle (0.8);
...
\node[inner sep=0pt] at ({\cw/2 - 0.4}, 1.8) {
  \includegraphics[width=3.2cm]{Physics_AI/graphical/regression.pdf}
};
...
% Subtitle
\node[darktext, font=\sffamily\small, text width=\cw cm, align=center] 
  at ({\cw/2}, 9.25) {Visually and quantitatively connect\\latent behavior with physical phenomena};
 
% ============================================
%  a) Parameter Correlation Matrix
% ============================================
\node[font=\sffamily\small\bfseries, darktext] at ({\cw/2}, 8.45) 
  {a) Latent Space Visualization \& Physical Insight};
 
\node[inner sep=0pt] at ({\cw/2 - 0}, 5.9) {
  \includegraphics[width=6.0cm]{Physics_AI/graphical/UMAP.pdf}
};
...
% ============================================
\node[font=\sffamily\small\bfseries, darktext] at ({\cw/2}, 3.3) 
  {b) Regression Activation Maps (RAMs)};
 
\node[inner sep=0pt] at ({\cw/2 - 0}, 2.3) {
  \includegraphics[width=6.0cm]{Physics_AI/graphical/RAMs.pdf}
};
